  ...
  return (
    <div className="min-h-screen flex flex-col transition-colors duration-300">
          ...
          <div className="flex items-center gap-6">
            <nav className="hidden xl:block">
              <ul className="flex gap-10 text-[11px] font-black uppercase tracking-[0.2em] themed-text-muted">
                {['ইতিহাস', 'ভৌগোলিক', 'ইসলামিক ঐতিহ্য', 'স্থাপত্য', 'ডিরেক্টরি'].map((item, i) => (
                  <li key={i}>
                    <button 
                      onClick={() => {
                        const sections = ['history', 'geo', 'islamic-heritage', 'islamic-architecture', 'directory'];
      ...
      <main id="main-content">
        ...
        <section id="history" className="py-32 bg-white dark:bg-black/20">
        ...
        <section id="geo" className="py-32 bg-gray-50 dark:bg-gray-900/20 overflow-hidden">
          <div className="container mx-auto px-6">
             <div className="text-center mb-24">
                <h2 className="text-sm font-black text-bd-red uppercase tracking-[0.5em] mb-4">প্রকৃতি ও ভূগোল</h2>
                <h3 className="text-5xl md:text-7xl font-black text-bd-green font-noto">সবুজ শ্যামল বাংলাদেশ</h3>
             </div>
        ...
        <section id="islamic-heritage" className="py-32 bg-white dark:bg-black/40">
          <div className="container mx-auto px-6">
        ...
        <section id="islamic-architecture" className="py-32 bg-gray-50 dark:bg-gray-900/10">
          <div className="container mx-auto px-6">
        ...
        {/* Full Directory Hub */}
        <section id="directory" className="py-32 bg-white dark:bg-[#080808]">
        ...
        {/* Emergency Dashboard */}
        <section id="emergency" className="py-24 bg-bd-red">
          <div className="container mx-auto px-6">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
              <div className="text-white max-w-xl text-center lg:text-left">
                <h2 className="text-4xl md:text-5xl font-black font-noto mb-6">জরুরি তথ্য কেন্দ্র</h2>
                <p className="text-white/80 text-xl font-medium mb-12">যেকোনো মুহূর্তে সহায়তার জন্য এই নম্বরগুলো মনে রাখুন। দেশের প্রতিটি নাগরিকের জন্য এই সেবাগুলো উন্মুক্ত।</p>
                <button onClick={() => handleSearch("বাংলাদেশের সকল গুরুত্বপূর্ণ জরুরি সেবা ও হেল্পলাইন নম্বরসমূহ জানাও")} className="bg-white text-bd-red px-12 py-5 rounded-full font-black uppercase tracking-widest hover:scale-105 transition-all shadow-2xl">সকল সেবা দেখুন</button>
              </div>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full lg:w-auto">
                {EMERGENCY_NUMBERS.map((num, i) => (
                  <div key={i} className="bg-white/10 backdrop-blur-xl p-10 rounded-[40px] border border-white/20 text-white min-w-[280px]">
                    <h4 className="text-lg font-bold mb-2 opacity-80">{num.title}</h4>
                    <p className="text-6xl font-black mb-6 tracking-tighter">{num.number}</p>
                    <p className="text-sm font-bold bg-white/20 inline-block px-4 py-1 rounded-full">{num.desc}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        {/* FAQ & Contact Section */}
        <section id="faq" className="py-32 bg-gray-50 dark:bg-black/40">
          <div className="container mx-auto px-6">
